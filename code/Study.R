...
############################################################################################
# REGRESSION STUDY
# This section runs 3 types of regression algorithms on the Sinc dataset.
# The MSE is calculated for each algorithm, and plots showing the RV/SVs and predictions are
# generated.
############################################################################################
...
############################################################################################
# Non-Kernel Bayesian Gaussian Linear Model Regression
############################################################################################
...
# This section runs 3 types of classification algorithms on the Half-Moons dataset.
# The MSE is calculated for each algorithm, and plots showing the RV/SVs and predictions are
# generated.
############################################################################################
